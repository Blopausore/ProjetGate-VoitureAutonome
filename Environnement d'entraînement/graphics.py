...
class ObservationGraphics(object):
    ...
    def display_grid(cls, lidar_observation, surface):
        #print(surface)
        #pygame.draw.line(surface,ObservationGraphics.COLOR, (100,-50) , (100,-100), 20 )
        
        for i in range(len(lidar_observation.grid)):
            #print(lidar_observation.grid[i])
            start = surface.pos2pix(lidar_observation.grid[i][0][0] + lidar_observation.origin[0] , lidar_observation.grid[i][0][1] + lidar_observation.origin[1])
            end = surface.pos2pix(lidar_observation.grid[i][1][0] + lidar_observation.origin[0] , lidar_observation.grid[i][1][1] + lidar_observation.origin[1])
            #print(lidar_observation.grid[i][0], lidar_observation.grid[i][1])
            #print(start,end)
            pygame.draw.line(surface,ObservationGraphics.COLOR, start, end)
        ...
        print(lidar_observation.grid[:,0])
        print((points))
